...
python do_getpatches() {
    import os
    newdir = d.getVar('THISDIR') + "/libgphoto2-2.5.8"
    ...
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/libgphoto2-2.5.8/avoid_using_sprintf.patch || pwd)" % (newdir)
