...
python do_getpatches() {
    import os
    newdir = d.getVar('THISDIR') + "/gphoto2-2.5.8"
    ...
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-graphics/gphoto2/gphoto2-2.5.8/0002-Look-for-popt-with-GP_CHECK_LIBRARY-function.patch || pwd)" % (newdir)
