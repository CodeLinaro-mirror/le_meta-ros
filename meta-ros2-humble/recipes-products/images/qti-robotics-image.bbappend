...
TOOLCHAIN_HOST_TASK:append = "${@bb.utils.contains('DISTRO_FEATURES', 'ros2', ' \
...
TOOLCHAIN_TARGET_TASK:append = "${@bb.utils.contains('DISTRO_FEATURES', 'ros2', ' \
    ament-cmake \
    ament-cmake-auto \
    ament-cmake-core \
