...
python do_getpatches() {
    import os
    newdir = d.getVar('THISDIR') + "/opencv"
    ...
    && (wget -c https://raw.githubusercontent.com/painterlake/meta-openembedded-my/master/meta-oe/recipes-support/opencv/opencv/fixpkgconfig.patch || pwd)" % (newdir)
